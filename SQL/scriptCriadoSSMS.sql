CREATE SCHEMA DesNatuFinal;
GO

CREATE TABLE DesNatuFinal.Ocorrencia(

codOcorrencia int not null,
codOcorrenciaAnterior int,
latitude varchar(50),
...
ALTER TABLE DesNatuFinal.Ocorrencia
ADD CONSTRAINT FK_OcorrenciaRecursiva foreign key (codOcorrenciaAnterior) references DesNatuFinal.Ocorrencia(codOcorrencia)

CREATE TABLE DesNatuFinal.EquipeTecnica(
...
CREATE TABLE DesNatuFinal.nomesEquipe(
codNome int not null,
nomeEquipe varchar(50) not null,
nomeTecnico varchar(50) not null,
constraint PK_NomeEquipe primary key (codNome),
constraint FK_nomesEquipeEquipeTecnica foreign key (nomeEquipe) references DesNatuFinal.EquipeTecnica(nome) on delete cascade on update cascade
);

ALTER TABLE DesNatuFinal.Ocorrencia
ADD CONSTRAINT FK_Ocorrencia_EquipeTecnica foreign key (nomeEquipe) references DesNatuFinal.EquipeTecnica(nome);


CREATE TABLE DesNatuFinal.Regional(
nomeRegional varchar(50),
constraint PK_Regional primary key (nomeRegional)
);

ALTER TABLE DesNatuFinal.Ocorrencia
ADD CONSTRAINT FK_Ocorrencia_Regional foreign key (nomeRegional) references DesNatuFinal.Regional(nomeRegional);


CREATE TABLE DesNatuFinal.OrgaoDestino(
nomeOrgao varchar(50) not null,
constraint PK_OrgaoDestino primary key (nomeOrgao)
);

ALTER TABLE DesNatuFinal.Ocorrencia
ADD CONSTRAINT FK_Ocorrencia_OrgaoDestino foreign key (nomeOrgao) references DesNatuFinal.OrgaoDestino(nomeOrgao);

CREATE TABLE DesNatuFinal.Morador(
...
CREATE TABLE DesNatuFinal.Telefone(
codTelefone int not null,
codCPF varchar(11) not null,
telefoneMorador varchar(15) not null,
constraint PK_Telefone primary key (codTelefone),
constraint FK_TelefoneMorador foreign key (codCPF) references DesNatuFinal.Morador(CPF)
);

ALTER TABLE DesNatuFinal.Ocorrencia
ADD CONSTRAINT FK_Ocorrencia_Morador foreign key (codCPF) references DesNatuFinal.Morador(CPF);


-- Inserção de valores na tabela Ocorrencia
INSERT INTO DesNatuFinal.Ocorrencia (
    codOcorrencia,
...
INSERT INTO DesNatuFinal.EquipeTecnica (nome) VALUES
('Equipe1'),
('Equipe2'),
('Equipe3'),
('Equipe4'),
...
INSERT INTO DesNatuFinal.nomesEquipe (codNome, nomeEquipe, nomeTecnico) VALUES
(1, 'Equipe1', 'Tecnico1'),
(2, 'Equipe2', 'Tecnico2'),
(3, 'Equipe3', 'Tecnico3'),
(4, 'Equipe4', 'Tecnico4'),
...
INSERT INTO DesNatuFinal.Regional (nomeRegional) VALUES
('Regional Norte'),
('Regional Sul'),
('Regional Leste'),
('Regional Oeste'),
...
INSERT INTO DesNatuFinal.OrgaoDestino (nomeOrgao) VALUES
('Orgao1'),
('Orgao2'),
('Orgao3'),
('Orgao4'),
...
INSERT INTO DesNatuFinal.Morador (CPF, RG, nome, sobrenome, rua, numero, bairro, complemento) VALUES
...
INSERT INTO DesNatuFinal.Telefone (codTelefone, codCPF, telefoneMorador) VALUES
